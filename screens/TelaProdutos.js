...
const TelaProdutos = () => {
  ...
  return (
    <View style={styles.telaprodutos}>
      <View style={[styles.headercontainer, styles.r4300Position]}>
      ...
      <View
        style={[styles.catalogocontainer, styles.catalogocontainerPosition]}
      >
        <View style={[styles.containerproduto, styles.containerprodutoLayout]}>
          <Image
            ...
            contentFit="cover"
            source={require("../assets/santaluciacabernet-11.png")}
          />
...
Torrontes`}</Text>
          ...
          <Image
            ...
            contentFit="cover"
            source={require("../assets/vinhopiattellitorrontes-1.png")}
          />
        </View>
...
Primitivo di Manduria`}</Text>
          ...
          <Image
            ...
            contentFit="cover"
            source={require("../assets/codiciprimitivodimanduria-1.png")}
          />
        </View>
        <View style={[styles.containerproduto3, styles.containerprodutoLayout]}>
          ...
          <Image
            style={[styles.codiciPrimitivoDiManduria1Icon, styles.iconLayout]}
            contentFit="cover"
            source={require("../assets/corbellimontepulcianodabruzzo-1.png")}
          />
        </View>
...
Helena`}</Text>
          ...
          <Image
            style={[styles.codiciPrimitivoDiManduria1Icon, styles.iconLayout]}
            contentFit="cover"
            source={require("../assets/vinhosantahelenacarmenre-1.png")}
          />
        </View>
...
Taylor’s Fine Ruby`}</Text>
          ...
          <Image
            ...
            contentFit="cover"
            source={require("../assets/taylor-sfineruby-1.png")}
          />
        </View>
...
Cabernet`}</Text>
          ...
          <Image
            style={[styles.codiciPrimitivoDiManduria1Icon, styles.iconLayout]}
            contentFit="cover"
            source={require("../assets/luigiboscacabernetsauvignon-1.png")}
          />
        </View>
...
Reserva Tannat`}</Text>
          ...
          <Image
            ...
            contentFit="cover"
            source={require("../assets/donpascualtannat-1.png")}
          />
        </View>
      </View>
